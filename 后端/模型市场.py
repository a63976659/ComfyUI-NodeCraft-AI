        ...
        try:
            ...
            async with aiohttp.ClientSession() as session:
                ...
                for f in siblings:
                    ...
                    if ext in weight_exts or fname in ('config.json', 'tokenizer.json', 'tokenizer_config.json', 'special_tokens_map.json', 'vocab.json', 'generation_config.json', 'model.safetensors.index.json'):
            ...
            async with session.put(
                ...
                if resp.status == 200:
                    ...
                    return [{
                        ...
                        "downloads": m.get("Downloads", 0),
                        "likes": m.get("Likes", 0),
                        "pipeline_tag": m.get("Tasks", [""])[0] if isinstance(m.get("Tasks"), list) and m.get("Tasks") else "",

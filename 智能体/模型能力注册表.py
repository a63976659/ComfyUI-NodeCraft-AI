...
class 模型能力注册表:
    ...
    _内置模型 = {
        "deepseek-v4-pro": {
            ...
            "擅长": ["编码", "推理", "通用"],
            "成本": "中",
            "描述": "DeepSeek 旗舰模型，编码和推理能力强，1M 上下文（官方文档 CONTEXT LENGTH 1M / MAX OUTPUT 384K）"
        },
        "deepseek-v4-flash": {
            "上下文窗口": 1000000,
            "擅长": ["编码", "通用", "对话"],
            "成本": "低",
            "描述": "DeepSeek V4 Flash，1M 上下文，速度快且经济（官方文档 CONTEXT LENGTH 1M / MAX OUTPUT 384K）"
        },
        "deepseek-chat": {
            "上下文窗口": 65536,
            "擅长": ["通用", "对话"],
        ...
        "qwen3.8-max": {
            ...
            "擅长": ["编码", "推理", "中文"],
            "成本": "高",
            "描述": "通义千问 3.8 Max（dashscope），按 qwen-max 家族保守登记 128K，避免未登记回退 32K 导致频繁压缩失忆（坑 98）"
        },
        "kimi-k3": {
            "上下文窗口": 1000000,
            "擅长": ["编码", "推理", "长文本"],
